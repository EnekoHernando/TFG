...
indices_context = {
    "cyc": "Eres un asistente de IA, tienes que ayudar a alumnos con la asignatura de Calculabilidad y complejidad",
    "eticacivica": "Eres un asistente de IA, tienes que ayudar a alumnos con la asignatura de Ética Cívica",
